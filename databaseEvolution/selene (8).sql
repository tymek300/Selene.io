...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2024 at 09:58 PM
...
(28, 'test0', 25.00, 25.00, 'testestowy', 8, 2, 3);
...
(52, 25, '../photos/productPhotos/Koenigsegg Jesko/koenigsegg_jesko_prototype_2019_5-HD.jpg', 0),
(53, 25, '../photos/productPhotos/Koenigsegg Jesko/2020-Koenigsegg-Jesko-012-2160-scaled.jpg', 1),
(55, 28, '../photos/productPhotos/test0/HD-wallpaper-uwu-otakus-pink-anime-cute-anime-girl-e-girl-waifu-removebg-preview.png', 1),
(56, 28, '../photos/productPhotos/test0/HD-wallpaper-uwu-otakus-pink-anime-cute-anime-girl-e-girl-waifu.jpg', 0);
...
(14, 'GrafiiPL', 'urygadawid1@gmail.com', '$2y$10$yK14Iohv3XLjdxwb7WtUU.wN2QhQUULZ1lmAtayDepnsbmWESUx.G', '2024-02-22', '../photos/profilePictures/1708632542pobrany_plik-removebg-preview.png', 4, 1, 1),
...
--
ALTER TABLE `cart_product`
  MODIFY `cart_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `product_categories`
  MODIFY `product_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `product_photos`
--
ALTER TABLE `product_photos`
  MODIFY `photo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `cart_product`
  ADD CONSTRAINT `cart_product_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
