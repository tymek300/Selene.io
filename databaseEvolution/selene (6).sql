...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2024 at 11:30 PM
...
(28, 'test0', 25.00, 25.00, 'testestowy', 0, 2, 3);
...
--
ALTER TABLE `favourite_product`
  MODIFY `favourite_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `product_review`
  MODIFY `product_review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
