...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 13, 2024 at 07:53 PM
...
(68, 2, 'Jakub', 'Uryga', 'urygajakub@gmail.com', '+48509989752', 3, '2024-05-13 15:46:13', 2),
(69, 3, 'Jakub', 'Uryga', 'urygajakub@gmail.com', '+48509989752', 3, '2024-05-13 17:21:45', 2);
...
(14, 13, 'd1bbe3c9688ae6786911', '2024-05-13 18:57:52', 0);
...
(3, 13, 'Polska', 'Kamionka Mała', '203', 'Laskowa', '34-602');
...
--
ALTER TABLE `cart_product`
  MODIFY `cart_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `password_reset`
  MODIFY `password_reset_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
