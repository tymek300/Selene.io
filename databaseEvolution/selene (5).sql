...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2024 at 12:36 AM
...
(1, 14, 25, 'In summary, the Koenigsegg Jesko represents the pinnacle of automotive engineering and is a true dream for enthusiasts of fast and exclusive vehicles. Its exceptional performance, advanced technology, and luxurious finishes make it one of the most coveted supercars on the market.', '2024-02-29', 5),
(2, 13, 25, 'Ogólnie fajne takie autko tak 2/10 to był dał pozdro z fartem.', '2024-02-29', 3),
(6, 13, 25, 'testowa opinia panie kolego', '2024-02-29', 2);
...
(15, 'testowyUser', 'tymek300pl@gmail.com', '$2y$10$hJ8OADBpJSZRRfEbOrlCSOX34FYx2jLWd.uFI1HPQVA4xzFXQUbFa', '2024-03-01', 'https://upload.wikimedia.org/wikipedia/commons/2/2c/Default_pfp.svg', 0);
...
--
ALTER TABLE `favourite_product`
  MODIFY `favourite_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
